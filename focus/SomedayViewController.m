...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    // Set the predicate
    NSPredicate *predicate = [NSPredicate predicateWithFormat:@"(finished == 0) && (isSomeday == 1)"];
    ...
    NSFetchedResultsController *aFetchedResultsController = [[NSFetchedResultsController alloc] initWithFetchRequest:fetchRequest managedObjectContext:self.managedObjectContext sectionNameKeyPath:nil cacheName:@"Someday"];
...
- (void)insertNewObject:(NSString *)title;
{
    ...
    [newManagedObject setValue:[NSNumber numberWithBool:YES] forKey:@"isSomeday"];
